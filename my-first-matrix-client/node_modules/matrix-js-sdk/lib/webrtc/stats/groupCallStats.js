...
class GroupCallStats {
  constructor(groupCallId, userId, interval = 10000) {
    ...
    (0, _defineProperty2.default)(this, "summaryStatsReportGatherer", new _summaryStatsReportGatherer.SummaryStatsReportGatherer(this.reports));
  }
  start() {
  ...
  updateOpponentMember(callId, opponentMember) {
    ...
    (_this$getStatsReportG = this.getStatsReportGatherer(callId)) === null || _this$getStatsReportG === void 0 ? void 0 : _this$getStatsReportG.setOpponentMemberId(opponentMember);
  }
  processStats() {
    const summary = [];
